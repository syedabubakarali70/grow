...
const Page = () => {
  return (
    <>
      <HeroSection />
      <div className="relative -top-16 z-30 mx-auto w-full max-w-screen-sm rounded-lg border bg-white p-0 pb-4 shadow-lg lg:-top-8 lg:max-w-4xl lg:pb-12 xl:max-w-[62rem]">
        <div
